export const navbarStyles = {
  // Main nav container
  nav: "w-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 shadow-xl py-1.5 sm:py-2 px-4 sm:px-6 lg:px-8 relative overflow-visible",
  ...
  // Main container
  container: "max-w-5xl mx-auto flex items-center justify-between relative z-10",
  ...
  logoImage: "h-8 w-8 sm:h-9 sm:w-9 rounded-full object-cover border-2 border-purple-300",
  
  // Title section
  titleContainer: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-full pointer-events-none",
  titleBackground: "bg-gradient-to-r from-blue-600/25 via-purple-600/25 to-indigo-600/25 xl:ml-40 backdrop-blur-sm px-3 py-1 sm:px-4 sm:py-1.5 rounded-full border border-white/10 shadow-md max-w-full",
  titleText: "text-sm sm:text-base md:text-lg lg:text-xl font-bold font-[pacifico] text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 text-center truncate",
...
export const sidebarStyles = {
  ...
  // Main content
  mainContent: "flex-1 flex items-start justify-center overflow-y-auto px-4 py-6",
  ...
  // Welcome screen
  welcomeContainer: "xl:pt-75 font-[pacifico] lg:pb-90 flex items-center justify-center",
  welcomeContent: "text-center font-[pacifico] max-w-xl mx-auto bg-white/90 backdrop-blur-sm p-5 md:p-8 rounded-2xl shadow-md border border-white",
  ...
  welcomeTitle: "text-xl md:text-3xl font-bold text-slate-800 mb-3 font-[pacifico]",
  welcomeDescription: "text-sm md:text-base text-slate-700 mb-4 max-w-sm mx-auto",
